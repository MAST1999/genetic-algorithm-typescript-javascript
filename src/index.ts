...
// calculate score
/**
 * Calculates the score of a target population
 * @param p This is the target population
...
/**
 * This is the main algorithm where the magic happens
 * @param population This is the population generated by the generatePopulation function
 * @param numberOfPopulation This is the number of people in our population
 * @param crossOverMargin This is the amount of cross over allowed
 * @param iterate This is the number of time that new generation will be created (-1)
 * @param mutationRate This is the possibility of mutation in a bit of a child
 * @param scores This is the scores or fitness of the population
 */
const algorithm = ({
  population,
  numberOfPopulation,
  ...
  mutationRate,
  scores,
}: GeneticAlgorithm): { bestPerson: number[]; bestScore: number } => {
  let bestScore = 0;
